     ...
     {isWeatherShown ? <Datetime reff={inputRef} options={options} /> :null}
        ...
        <div className="main-searchbox__container">
            ...
            <form action="#" className='main-searchbox__form'>
             <input type="text" id='searchbox' placeholder='Enter the name of a ski resort' ref={inputRef} required/>
                < SearchBtn  handleSubmit={handleSubmit} onSubmit={handleSubmit} reff={inputRef}/>
            </form>
        </div>
        {isWeatherShown ? <Country reff={inputRef} /> :null} 
        
        {}
      {isWeatherShown ? <Futureweather reff={inputRef} options={options} lat={lat} lon={lon} /> :null} 
